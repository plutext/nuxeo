...
public class DownloadServiceImpl extends DefaultComponent implements DownloadService {
    ...
    private static final Pattern JSESSION_ID_REGEX = Pattern.compile(";jsessionid=[^?]*", Pattern.CASE_INSENSITIVE);
    ...
    protected String getSanitizedFilenameWithoutPath(String filename) {
        ...
        return JSESSION_ID_REGEX.matcher(filename).replaceAll(StringUtils.EMPTY);
    }
